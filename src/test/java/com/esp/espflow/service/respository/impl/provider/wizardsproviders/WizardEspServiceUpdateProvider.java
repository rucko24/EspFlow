...
public class WizardEspServiceUpdateProvider implements ArgumentsProvider {

    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {

        WizardEspDto wizardReadFlashViewDto = WizardEspDto.builder()
                .id(1L)
                .name(WIZARD_READ_FLASH_ESP_VIEW)
                .isWizardEnabled(false)
                .build();

        WizardEspDto wizardReadFlashViewDtoToSave = WizardEspDto.builder()
                .id(1L)
                .name(WIZARD_READ_FLASH_ESP_VIEW)
                .isWizardEnabled(false)
                .build();
        ...
        WizardEspEntity updatedEntity = new WizardEspEntity();
        updatedEntity.setId(1L);
        updatedEntity.setWizardEnabled(true);
